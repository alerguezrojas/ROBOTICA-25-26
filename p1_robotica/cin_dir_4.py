...
# Parámetros D-H:
#         0'    1       2         3          4     41      42    51    52     61      62       ef
d  = [ p[0],    0,      0,        0,        50,     0,      0,   10,   10,  p[5],   p[5], 10+p[5]]
th = [    0,    0,   p[1],  90+p[2],      p[3],     0,      0,    0,    0,     0,      0,      0]
a  = [    0,   20,     20,        0,         0,  p[4],  -p[4],    0,    0,     0,      0,      0]
...
T0p=matriz_T(d[0],th[0],a[0],al[0])
Tp1=matriz_T(d[1],th[1],a[1],al[1])
...
T4252=matriz_T(d[8],th[8],a[8],al[8])
...
muestra_origenes([o00,op0, o10, o20, o30, o40, [[o410, o510, o610], [o420, o520, o620]]], oef0)
muestra_robot   ([o00,op0, o10, o20, o30, o40, [[o410, o510, o610], [o420, o520, o620]]], oef0)
input()